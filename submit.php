...
if(isset($_POST['submit'])){
    ...
    $i="insert into itemtb(itemName,itemCat,itemLoc,itemIMG,user_contact,user_email,user_name)values('$n','$c','$l','$img','$usercontact','$useremail','$userfullname')";
...
<body>
    <header> 
        ...
        <ul>
            ...
            <li><a href="#" class="active">Submit Events</a></li>
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="category" placeholder="Event Date" required>
                           ...
                           <div class="col-md-12">
                              <input class="form-control" type="text" name="location" placeholder="Event Venue" required>
