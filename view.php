...
<div class="col-md-4 mt-5">
    		<div class="card">
    			...
    			<div class="card-body">
    				...
    				<center><h2 class="card-title"><?php echo $row['itemName']; ?></h2></center>
    				<p class="card-text">
    					Date: <?php echo $row['itemCat']; ?>
    				</p>
    				...
    				<p class="card-text">
    					Organizer Details:<br> <?php echo $row['user_contact']; ?>
    				</p>
    				<p class="card-text">
